              ...
              <div className="content-column col-lg-7 col-md-12 col-sm-12">
                <div className="inner-column">
                  <div className="title-box">
                    <h2>Archo studio</h2>
                    <p>
                      Founded in Lebanon in 1967, Archo Architecture Company
                      (KCC) has grown to become one of <br /> the Middle East's
                      leading construction contractors.
                    </p>
                    <p>
                      We specialise in complex and prestigious construction and
                      infrastructure projects. Our portfolio includes some of
                      the region’s most iconic landmarks, from super high-rise
                      luxury developments, to five star hotels, hospitals and
                      intricately sophisticated smart buildings.
                    </p>
                  </div>
                    ...
                    <div className="specialise-box">
                      <div className="inner-box">
                        <div className="content">
                          ...
                          <p>
                            We provide all materials, labor, equipment and
                            services, etc and ensure a safe and secure project
                            site.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="specialise-box">
                      <div className="inner-box">
                        <div className="content">
                          ...
                          <p>
                            We developed strong relationships with contractors
                            and specialist companies offering discounted prices
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="clearfix">
                    ...
                    <div className="pull-left">
                      <ul className="product-tab-btns clearfix">
                        <li
                          className="p-tab-btn active-btn"
                          data-tab="#p-tab-1"
                        >
                          All
                        </li>
